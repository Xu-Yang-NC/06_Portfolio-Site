        ...
        <Swiper navigation={true} className='mySwiper'>
          ...
          <SwiperSlide className='project-2'>
            <div className='project-content'>
              ...
              <p>
                This is my first application using JavaScript. This application
                is a shopping list chrome extension which items can be simply
                added to or removed from the list. All the entering data will be
